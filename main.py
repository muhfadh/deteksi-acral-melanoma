...
def predict():
    ...
    model_dict = {'model1'   :   'static/MLModule/model-2-89%.h5',
                  'model2'   :   'static/MLModule/model-6-89%.h5',}
    ...
    return predict_result(chosen_model, runtimes, respon_model, 'temp.jpg', labels)
